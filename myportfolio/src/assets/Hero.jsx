...
function Hero() {
 ...
 <div class="border-2 border-white-600"><img src="IMG_0231.jpg" alt="" width={550} /></div>
 </div>
<div class="my-40">
   <div class="-mb-5 font-serif text-[20px]"><p>Hello, I'm Jayraj</p></div>
   <div class="text-[80px] -mb-10 font-bold -mx-10 text-[#A6BBCC] ">Frontend</div>
   <div class="text-[80px] font-bold text-[#A6BBCC]">Developer</div>
   <a href="/Jayraj_resume.pdf" download="Jayraj_resume.pdf" ><div class="underline underline-offset-8 hover:text-[#A6BBCC]">Dowload Resume</div></a>

   <div id="about" >
        <h1 class="font-bold text-[70px] underline underline-offset-8 text-left mt-55   text-[#A6BBCC]">about</h1> <br />

        <div class="text-left  "><p> They also focus on optimizing performance and accessibility, ensuring that all users, regardless of their abilities or devices, can navigate and interact with the web applications effectively.  Additionally, frontend developers often utilize version control systems like Git to manage code changes and collaborate with team members efficiently, fostering a productive development environment.</p></div> <br />

      <div class=" gap-20  font-extrabold text-[30px] text-left " >
        <h1>⦾ React.js</h1> 
        <h1>⦾ Javascript</h1>
        <h1>⦾ Web Desing</h1>
     ...
     <div id='work'>
        <h1 class="font-bold text-[70px] underline underline-offset-8 text-left   text-[#A6BBCC]">Work</h1> <br />

        <div class="text-left  "><p> Developed responsive web applications using HTML, CSS, and JavaScript, ensuring optimal performance across various devices and browsers.
...
Conducted thorough testing and debugging of applications to ensure cross-browser compatibility and adherence to web standards.
          ...
          <h1 class="text-[30px] font-extrabold text-[#A6BBCC]">My Projects</h1> <br />

          <div class="font-bold text-[20px] text-left">1.Car website(using HTML,CSS,BOOTSTRAP)</div> <br />

          <div class="border-2 border-white-600"><img src="p1.png" alt="" /></div>
         
        

        <br /><br />

<div class="font-bold text-[20px] text-left">2.Jewellery Website(using HTML,CSS,BOOTSTRAP,JAVASCRIPT)</div> <br />

<div class="border-2 border-white-600"><img src="p2.png" alt="" /></div> <br />

<h1 class="font-bold text-[70px] underline underline-offset-8 text-left   text-[#A6BBCC]" id='con'>Contact Me</h1> 


<div class="bg-black text-white flex items-center justify-center min-h-screen -mt-60 ">
<div class="container mx-auto p-5">
<div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
<div class="bg-gray-900 p-6 rounded-lg shadow-lg">
                <div class="text-green-500 text-4xl mb-4">☎️</div>
                <p class="text-lg font-semibold">+91 9510914017</p>
                <p class="text-gray-400">Contact Phone</p>
            </div>

            <div class="bg-gray-900 p-6 rounded-lg shadow-lg">
                <div class="text-green-500 text-4xl mb-4">✉️</div>
                <p class="text-lg font-semibold">jayrajzinzala95@gmail.com</p>
                <p class="text-gray-400">Contact Email</p>
            </div>

            <div class="bg-gray-900 p-6 rounded-lg shadow-lg">
                <div class="text-green-500 text-4xl mb-4">📍</div>
                <p class="text-lg font-semibold">Surat, Gujarat, India</p>
                <p class="text-gray-400">Contact Location</p>
            </div>
...
<div class="container mx-auto px-5 py-24 -mt-60">
...
<footer class="w-full py-14">
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="max-w-3xl mx-auto">
                    ...
                    <ul class="text-lg flex items-center justify-center flex-col gap-7 md:flex-row md:gap-12 transition-all duration-500 py-16 mb-10 border-b border-gray-200 text-[white]">
                ...
                <a href="#con" class="text-white hover:text-gray-200">Contact Me</a>
                    ...
                    <div class="flex space-x-10 justify-center items-center mb-14">
                        ...
                        <a href="https://www.instagram.com/jayraj_zinzala/" class="block  text-gray-900 transition-all duration-500 hover:text-indigo-600 ">
                    ...
                    <span class="text-lg text-gray-500 text-center block">©<a href="">jayraj</a> 2024, All rights reserved.</span>
            </div>
        </div>
    </footer>
